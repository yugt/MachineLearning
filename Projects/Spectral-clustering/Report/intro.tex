...
The overview of this algorithm is described intuitively in \autoref{overview}. 

\begin{figure}[htbp]
\centering
\vspace{-1em}
\includegraphics[width=0.9  \textwidth]{cross_shaped.png}
\vspace{-1em}
...
\vspace{1em}
\caption{Overview of the Algorithm 4}
\label{overview}
\end{figure}
