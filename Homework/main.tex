...
\paragraph{(b)}
Facial variations of the zeroth orfer principal eigenvector captures the most common feature (the existence of eyes, nose, mouth and eyebrows).
The first 4 eigenvectors capture the shading, where the second eigenvector especially capturs the directed shading from the left to the right.
